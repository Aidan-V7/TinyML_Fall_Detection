...
/* Includes ---------------------------------------------------------------- */
#include <Fall_Detection_V2_inferencing.h>
...
#define RED_LED_PIN 5    // change to your wiring
#define GREEN_LED_PIN 6  // change to your wiring

/** Used sensors value function connected to label name */
eiSensors sensors[] =
{
    "acc_x", &data[0], &poll_acc, &init_IMU, NOT_USED,
    "acc_y", &data[1], &poll_acc, &init_IMU, NOT_USED,
    "acc_z", &data[2], &poll_acc, &init_IMU, NOT_USED,
    "gyro_x", &data[3], &poll_gyr, &init_IMU, NOT_USED,
    "gyro_y", &data[4], &poll_gyr, &init_IMU, NOT_USED,
    "gyro_z", &data[5], &poll_gyr, &init_IMU, NOT_USED,
